...
macaca <- read_csv("./Metagenomics/macaca_estimates_by_viral_family.csv")
ptero <- read_csv("./Metagenomics/pteropus_estimates_by_viral_family.csv")
...
set.seed(721)
cols <- c(met.brewer("Signac", 10), 'gray90')
